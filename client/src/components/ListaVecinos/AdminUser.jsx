...
import { ENDPOINT, deleteUsuario, fetchAdminUsuarios } from '../../api'
// Import css/imagenes
import styles from '../../css/admin.module.css'
import placeholder from '../../css/img/placeholder.png'

export default function AdminUser({ id, image, vecino, mail }) {
  ...
  const handleDelete = () => {
    deleteUsuario(user.token, id).then((response) => {
      if (response.deleted) {
